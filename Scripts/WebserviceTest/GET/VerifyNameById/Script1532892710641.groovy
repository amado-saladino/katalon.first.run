...
for (def row = 1; row <= findTestData('UserData').getRowNumbers(); row++) 
{
	request= findTestObject('API/GetUsers')
	params.add(new TestObjectProperty("id", ConditionType.EQUALS, findTestData('UserData').getValue("id", row)))
...
println "End of Users test case"
